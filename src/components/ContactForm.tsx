					...
					<div
						...
						{field.isTextArea ?
							<textarea
								...
								className='w-full resize-none rounded-lg border border-slate-900 bg-slate-950 p-3 text-sm text-slate-200 placeholder-slate-600 outline-none transition-colors focus:border-teal-500/50'
							/>
						:	<input
								type={field.type}
								placeholder={field.placeholder}
